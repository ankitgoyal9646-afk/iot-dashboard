...
client.on('connect', () => {
    ...
    // Dono topics ko subscribe karein: data ke liye bhi aur commands ke liye bhi
...
// 2. DASHBOARD SE COMMAND ESP32 TAK BHEJNA (NEW)
io.on('connection', (socket) => {
    console.log("📱 Dashboard Connected to Socket");

    // Dashboard se 'led_command' milne par
    socket.on('led_command', (status) => {
        console.log("💡 LED Command Received:", status);
        // MQTT Topic par ON/OFF publish karein taaki ESP32 sun sake
